...
public class FormAgregarCelulares implements Iniciador{
	...
	public void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			conection.AumentarCantidadCelulares(MarcaCB.getSelectedItem().toString(), ProductoCB.getSelectedItem().toString(),Integer.parseInt(CantidadCB.getText()));
			}
		});
